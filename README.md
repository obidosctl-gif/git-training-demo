...
3. Modify a file and commit the change.
4. Push the branch to GitHub.
5. Create a pull request.
6. Create two branches that modify the same lines.
7. Merge one branch and resolve the conflict from the other branch.
